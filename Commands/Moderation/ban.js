...
module.exports = {
  ...
  async execute(interaction, client) {
    ...
    if (guild.ownerId === member.id) return EditReply(interaction, "❌", `You cant ban the server owner`)
    if (guild.members.me.roles.highest.position <= member.roles.highest.position) return EditReply(interaction, "❌", `You cant ban a member of your same level or higher!`)
    if (interaction.member.roles.highest.position <= member.roles.highest.position) return EditReply(interaction, "❌", `I cant ban a member of my same level or higher!`)
